      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/main" className="block">
            ...
            <div className="w-[0px] h-40  border-cyan-600 rounded-bl-full rounded-br-full 2xl:w-52 bg-opacity-50 justify-center flex items-center">
              <img
