                ...
                <div class="w-1/3 h-1/3 mt-2 justify-center items-center">
                  <div className="justify-center items-center text-center font-semibold text-gray-600 flex-col flex">
                    <GaugeChart
                      ...
                      arcPadding={0}
                    />
                    <span className="-mt-1 ml-[2.2px] -pt-4 leading-none">83%<br/></span>
                    Performance
                  </div>
                </div>
              </div>
                ...
                <div class="w-full h-fit text-center items-center justify-center flex">
                  <div class="flex flex-wrap justify-center py-4 lg:pt-4 pt-8 w-11/12">
                    <div class="mr-4 p-3 text-center">
                      <span class="text-xl font-bold block e tracking-wide text-gray-800">
                        ML Engineer
                      </span>
                      <span class="text-sm text-blueGray-400">Designation</span>
                    </div>
                    <div class="mr-4 p-3 text-center">
                      <span class="text-xl font-bold block  tracking-wide text-gray-800">
                        Technical
                      </span>
