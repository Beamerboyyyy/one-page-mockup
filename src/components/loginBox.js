    ...
    <div className="relative flex flex-col justify-center h-1/2 overflow-hidden  ">
      <div className="w-full p-6 m-auto rounded-md shadow-xl lg:max-w-xl">
        ...
        <form className="mt-6" onSubmit={goToMain} >
          ...
          <div className="mt-6">
            <button
              ...
              type='submit'
              className="w-full px-4 py-2 ease-in  duration-30  bg-[#ce2026] tracking-wide text-gray-900 font-bold transition-colors0 transform  rounded-md hover:bg-gray-600 hover:text-white focus:outline-none focus:bg-blue-600"
            >
              Login
            </button>
          </div>
        ...
        <div className="relative flex items-center justify-center w-full mt-6 border">
          <div className="absolute px-5 bg-[#ce2026] text-gray-900 font-semibold w-fit rounded-xl">Or</div>
        </div>
