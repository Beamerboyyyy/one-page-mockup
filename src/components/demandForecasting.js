...
export default function DemandForecasting() {
  return (
    <section
      ...
      className="py-10 text-white mt-8 "
    >
      <div className="text-center mt-8 h-fit">
        <div className="flex justify-center items-center">
        <h3 className="link link-underline link-underline-black text-4xl font-black border-t-2 border-white pt-2 text-black w-fit">Demand Forecasting</h3>
        </div>
